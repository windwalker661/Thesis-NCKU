...
%%% 附錄編排碼 begin >>>
% \newpage
% \chapter*{} % 修改附錄編號與你的附錄名
% \phantomsection % for hyperref to register this
% \addcontentsline{toc}{chapter}{} %建議此內容應與上行相同
...
%%% 附錄編排碼 begin >>>
% \newpage
% \chapter{Appendix B: MATLAB / Octave } % 修改附錄編號與你的附錄名
% \phantomsection % for hyperref to register this
% \addcontentsline{toc}{chapter}{Appendix B: MATLAB / Octave} %建議此內容應與上行相同
%\setcounter{chapter}{0}  %如果用的是 TeXLive2007 則打開此行以避免錯誤
% \setcounter{equation}{0} 
% \setcounter{figure}{0} 
% \setcounter{footnote}{0} 
